...
pub(crate) const LSSA_URL: &str = "https://github.com/logos-blockchain/lssa.git";
pub(crate) const DEFAULT_LSSA_PIN: &str = "dee3f7fa6f2bf63abef00828f246ddacade9cdaf";
...
pub(crate) const FRAMEWORK_KIND_LSSA_LANG: &str = "lssa-lang";
