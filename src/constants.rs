...
pub(crate) const LSSA_URL: &str = "https://github.com/logos-blockchain/logos-execution-zone.git";
pub(crate) const DEFAULT_LSSA_PIN: &str = "767b5afd388c7981bcdf6f5b5c80159607e07e5b";
